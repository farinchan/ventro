  ...
  <div class="authentication-inner row m-0">
    ...
    <div
      ...
      <div class="w-px-400 mx-auto pt-12 pt-lg-0">
        ...
        <form id="formAuthentication" class="mb-5" action="{{ route('auth.register.store') }}" method="POST">
          @csrf
          ...
          <div class="mb-5 form-control-validation">
            <div class="form-check mt-2">
              <input class="form-check-input" type="checkbox" id="terms-conditions" name="terms" value="1" {{ old('terms') ? 'checked' : '' }} required />
