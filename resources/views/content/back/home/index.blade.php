...
@section('content')
  <div
    ...
    <div class="d-flex align-content-center flex-wrap gap-4">
      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createApp">Create
        Business</button>
    </div>
  </div>
  <div class="row g-6">
        ...
        <div class="card h-100">
            ...
            <div class="d-flex align-items-center">
              <div class="d-flex align-items-center">
                <div class="avatar me-4">
                  <img src="{{ $business->logo }}" alt="Avatar" class="rounded-circle" />
                </div>
                <div class="me-2">
                  <h5 class="mb-0"><a href="{{ route('fnb.dashboard.index', $business->slug) }}"
                      class="stretched-link text-heading">{{ $business->name }}</a></h5>
          ...
          <div class="card-body">
            <div class="d-flex flex-wrap">
              <div class="bg-lightest px-3 py-2 rounded-3 me-2 mb-4">
                <p class="mb-1"><span class="fw-medium text-heading">{{ $business->outlets->count() }}</span>
                  <span>/{{ $business->license->max_outlets ?? 'Unlimited' }}</span></p>
                <span class="text-body">Outlet</span>
              </div>
              <div class="bg-lightest px-3 py-2 rounded-3 me-2 mb-4">
                <p class="mb-1"><span class="fw-medium text-heading">0</span>
                  <span>/{{ $business->license->max_transactions_per_day ?? 'Unlimited' }}</span></p>
          ...
          <div class="card-body border-top">
            <div class="d-flex align-items-center mb-4">
              <p class="mb-1"><span class="text-heading fw-medium">License: </span>
                <span>{{ $business->license?->name ?? 'No License' }}</span></p>
