        ...
        <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                @guest
                    ...
                    <li>
                        <a href="{{ route('login') }}" class="btn btn-primary px-2 px-sm-4 px-lg-2 px-xl-4"><span
                                class="icon-base ri ri-user-line me-md-1"></span><span
                ...
                @auth
                    <!-- navbar button: Start -->
                    <li>
                        <a href="{{ route('business') }}" class="btn btn-primary px-2 px-sm-4 px-lg-2 px-xl-4"><span
                                class="icon-base ri ri-dashboard-line me-md-1"></span><span
                                class="d-none d-md-block">Manage My business</span></a>
                    </li>
                    <!-- navbar button: End -->
                @endauth
            </ul>
